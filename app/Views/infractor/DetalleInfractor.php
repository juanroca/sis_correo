...
<body class="hold-transition sidebar-mini layout-fixed" style="height: auto;">
    ...
    <table width="100%">
        <tbody>
            ...
            <tr>
                <td style="width: 50%;"><img src="<?php echo base_url() . "/assest/img/infractor/" . $infractor['foto1']; ?>" alt="" style="width:50%;"></td>
                <td style="width: 50%;"> <img src="<?php echo base_url() . "/assest/img/infractor/" . $infractor['foto2']; ?>" alt="" style="width:50%;"></td>
            </tr>
        </tbody>
    </table>
