...
<body class="hold-transition sidebar-mini layout-fixed" style="height: auto;">
    ...
    <table border="0" style="height: 36px; width: 100%; border-collapse: collapse;">
        <tbody>
            <tr style="height: 18px;">
                ...
                <td style="width: 20%; height: 18px;">Tipo de caso</td>
            </tr>
            <tr style="height: 18px;">
                ...
                <td style="width: 20%; height: 18px; vertical-align: top;"><em><?php echo $casos['clase']; ?></td>
            </tr>
        </tbody>
    </table>
    <table border="0" style="height: 35px; width: 100%; border-collapse: collapse;">
        <tbody>
            <tr style="height: 18px;">
                <td style="width: 40%; height: 18px;">Lugar del hecho</td>
                <td style="width: 20%; height: 18px;">Barrio</td>
                <td style="width: 10%; height: 18px;">U.V.</td>
                <td style="width: 15%; height: 18px;">Latitud</td>
                <td style="width: 15%; height: 18px;">Longitud</td>                
            </tr>
            <tr style="height: 18px;">
                <td style="width: 40%; height: 18px; vertical-align: top;"><em><?php echo $casos['lug_hecho']; ?></td>
                <td style="width: 20%; height: 18px; vertical-align: top;"><em><?php echo $casos['barrio']; ?></td>
                <td style="width: 10%; height: 18px; vertical-align: top;"><em><?php echo $casos['uv']; ?></td>
                <td style="width: 15%; height: 18px; vertical-align: top;"><em><?php echo $casos['latitud']; ?></td>
                <td style="width: 15%; height: 18px; vertical-align: top;"><em><?php echo $casos['longitud']; ?></td>
        </tbody>
    </table>
    <table border="0" style="height: 35px; width: 100%; border-collapse: collapse;">
        <tbody>
            <tr style="height: 18px;">
                <td style="width: 40%; height: 18px;">Naturaleza del hecho</td>
                <td style="width: 20%; height: 18px;">Claves</td>
                <td style="width: 40%; height: 18px;">Clasificacion</td>
            </tr>
            <tr style="height: 18px;">
                <td style="width: 40%; height: 18px; vertical-align: top;"><em><?php echo $casos['nat_hecho']; ?></td>
                <td style="width: 20%; height: 18px; vertical-align: top;"><em><?php echo $casos['clave_pri'] . " " . $casos['clave_sec'] . " " . $casos['clave_ter']; ?></td>
                <td style="width: 40%; height: 18px; vertical-align: top;"><em><?php echo $casos['clasific']; ?></td>
    ...
    <table width="100%">
        <tbody>
            <tr>
                <td style="width: 70%;">Fotografía 1</td>
                <!-- <td style="width: 50%;">Fotografía 2</td> -->
            </tr>
            <tr>
                <td style="width: 70%;"><img src="<?php echo base_url() . "/assest/img/casos/" . $casos['foto1']; ?>" alt="" style="width:50%;"></td>
                <!-- <td style="width: 50%;"> <img src="<?php echo base_url() . "/assest/img/casos/" . $casos['foto2']; ?>" alt="" style="width:50%;"></td> -->
            </tr>
        </tbody>
    </table>
